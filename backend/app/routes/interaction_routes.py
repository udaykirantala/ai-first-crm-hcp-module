...
def create_form_interaction(data: FormInteractionRequest):
    ...
    response = log_interaction(interaction_data)
    ...
    try:
        ...
        for interaction in interactions:
            ...
            result.append({
                ...
                "followup_recommendation": interaction.followup_recommendation
            })
...
def update_interaction(
    ...
    try:
        ...
        interaction.follow_up = updated["updated_data"]["follow_up"]
